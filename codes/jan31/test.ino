...
int const qtrsetpoint = 2500;    // constant setpoint for qtr array PID
int const sharpsetpoint = 260; // constant setpoint for distance sensor PID
...
int speedRightBase = 100;  // base speeds of motors during line follow
...
void setup()
{
	...
	initialDriveBool = true; // the initial drive will be the first function called
