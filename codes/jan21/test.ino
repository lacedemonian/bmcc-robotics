...
QTRSensorsRC qtrrc((unsigned char[]) { A9, A10, A11, A12, A13, A14 }, // six middle sensors used to follow a line
...
QTRSensorsRC qtrrcA((unsigned char[]) { A8, A15 }, // two outer sensors used to detect cross-sections (not used in tuning)
...
int ENA = 8, ENB = 9;    // assign motors to a pmw pin
...
bool initialDrive, pidFollowTrue, decisionBool;
