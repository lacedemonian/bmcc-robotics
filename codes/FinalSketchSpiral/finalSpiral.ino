...
{
	lcd.setCursor(0, 0);
	lcd.print("p:"); lcd.print(Kp,DEC); lcd.setCursor(8,0);
	lcd.print(" d:"); lcd.print(Kd, DEC); lcd.setCursor(16, 0);
	lcd.print(" "); lcd.setCursor(0, 1); lcd.print("i:");
	lcd.print(Ki,DEC); lcd.setCursor(8,1); lcd.print(" ");
